// ORM class for table 'mdm_category'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon Oct 16 18:42:10 IST 2017
...
public class mdm_category extends SqoopRecord  implements DBWritable, Writable {
  ...
  public mdm_category with_code(String code) {
    this.code = code;
    return this;
  }
  ...
  public mdm_category with_description(String description) {
    this.description = description;
    return this;
  }
  ...
  public mdm_category with_status(String status) {
    this.status = status;
    return this;
  }
  ...
  public mdm_category with_created_by(String created_by) {
    this.created_by = created_by;
    return this;
  }
  ...
  public mdm_category with_created_on(java.sql.Timestamp created_on) {
    this.created_on = created_on;
    return this;
  }
  ...
  public mdm_category with_modified_by(String modified_by) {
    this.modified_by = modified_by;
    return this;
  }
  ...
  public mdm_category with_modified_on(java.sql.Timestamp modified_on) {
    this.modified_on = modified_on;
    return this;
  }
  ...
  public mdm_category with_tennant_id(String tennant_id) {
    this.tennant_id = tennant_id;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof mdm_category)) {
      return false;
    }
    mdm_category that = (mdm_category) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.created_on = JdbcWritableBridge.readTimestamp(5, __dbResults);
    this.modified_by = JdbcWritableBridge.readString(6, __dbResults);
    this.modified_on = JdbcWritableBridge.readTimestamp(7, __dbResults);
    this.tennant_id = JdbcWritableBridge.readString(8, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeTimestamp(created_on, 5 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(modified_by, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeTimestamp(modified_on, 7 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(tennant_id, 8 + __off, 12, __dbStmt);
    return 8;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    mdm_category o = (mdm_category) super.clone();
  ...
  public void clone0(mdm_category o) throws CloneNotSupportedException {
    o.created_on = (o.created_on != null) ? (java.sql.Timestamp) o.created_on.clone() : null;
    o.modified_on = (o.modified_on != null) ? (java.sql.Timestamp) o.modified_on.clone() : null;
  }
